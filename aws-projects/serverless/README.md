...
An Amazon API Gateway is a collection of resources and methods. Now we create one resource (DynamoDBManager) and define one method (POST) on it. The method is backed by a Lambda function (LambdaFunctionOverHttps). That is, when you call the API through an HTTPS endpoint, Amazon API Gateway invokes the Lambda function.
...
![Create function](./create-lambda.jpg)
...
![Lambda basic information](./lambda-basic-info.jpg)
...
```
![Lambda Code](./lambda-code-paste.jpg)
...
![Configure test events](./lambda-test-event-create.jpg)
...
```
![Save test event](./save-test-event.jpg)

3. Click "Test", and it will execute the test event. You should see the output in the console

![Execute test event](./execute-test.jpg)
...
![create DynamoDB table](./create-dynamo-table.jpg)
...
![create API](./create-api-button.jpg) 

3. Scroll down and select "Build" for REST API

![Build REST API](./build-rest-api.jpg) 

4. Give the API name as "DynamoDBOperations", keep everything as is, click "Create API"

![Create REST API](./create-new-api.jpg)
...
![Create resource method](./create-method-1.jpg)

8. Select "POST" from drop down , then click checkmark

![Create resource method](./create-method-2.jpg)
...
![Create lambda integration](./create-lambda-integration.jpg)
...
![Copy Invoke Url](./copy-invoke-url.jpg)
...
2. To execute our API from local machine, we are going to use Postman and Curl command. You can choose either method based on your convenience and familiarity. 
    * To run this from Postman, select "POST" , paste the API invoke url. Then under "Body" select "raw" and paste the above JSON. Click "Send". API should execute and return "HTTPStatusCode" 200.
    ...
    ![Execute from Postman](./create-from-postman.jpg)
...
```
![List Dynamo Items](./dynamo-item-list.jpg)
